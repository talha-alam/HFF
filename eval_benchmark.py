...
def evaluate_directory(image_dir, nude_classifier, q16_classifier, args, device):
    ...
    nsfw_count = sum(1 for result in classification_results.values() if result['nude_net'] == 1 or result['q16'] == 1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default='evaluation_reports_after_FT', help='Directory to save the output JSON report files.')
